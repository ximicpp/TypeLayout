...
See xref:design/signature-format.adoc[Signature Format] for details.
...
See xref:design/hash-algorithms.adoc[Hash Algorithms] for details.
...
See xref:design/portability-strategy.adoc[Portability Strategy] for details.
