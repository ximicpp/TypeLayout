...
* xref:reference/core-functions.adoc#get_layout_signature[get_layout_signature] - Returns `CompileString`
...
* xref:reference/core-functions.adoc#get_layout_verification[get_layout_verification] - Returns `LayoutVerification`
