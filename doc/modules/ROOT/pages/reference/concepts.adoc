...
* xref:core-functions.adoc#is_portable[is_portable] - Underlying function
...
* xref:core-functions.adoc#signatures_match[signatures_match] - Underlying function
...
* xref:core-functions.adoc#get_layout_signature[get_layout_signature] - Underlying function
* xref:utility-classes.adoc#CompileString[CompileString] - Compile-time string type
...
* xref:core-functions.adoc#get_layout_hash[get_layout_hash] - Underlying function
* xref:core-functions.adoc#get_layout_verification[get_layout_verification] - Dual-hash alternative
