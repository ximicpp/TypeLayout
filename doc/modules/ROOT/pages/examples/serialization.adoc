...
static_assert(is_serializable_v<FileHeader, PlatformSet::bits64_le()>,
    "FileHeader must be serializable for file compatibility");
----
...
static_assert(is_serializable_v<Record, PlatformSet::bits64_le()>,
    "Record must be serializable for binary persistence");
