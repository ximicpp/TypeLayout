...
* xref:layout-signatures.adoc[Layout Signatures] - Signature format
* xref:portability.adoc[Portability] - Portability considerations
* xref:type-support.adoc[Type Support] - Supported types
