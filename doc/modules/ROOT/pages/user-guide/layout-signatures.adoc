...
* xref:type-support.adoc[Type Support] - Complete list of supported types
* xref:portability.adoc[Portability] - Platform-dependent type handling
* xref:inheritance.adoc[Inheritance] - How base classes are represented
