...
* Collision probability for 2 types: ~5.4 × 10^-20^
...
* xref:layout-signatures.adoc[Layout Signatures] - Full signature format
* xref:concepts.adoc[Concepts] - LayoutHashMatch concept
* xref:portability.adoc[Portability] - Platform considerations
