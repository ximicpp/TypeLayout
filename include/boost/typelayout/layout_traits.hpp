...
struct layout_traits {
    ...
    // Cross-validate bitmap has_padding against sig_has_padding.
    // Skipped for opaque types: bitmap treats them as atomic, but the
    // signature may embed sub-structure with padding markers.
    static_assert(
