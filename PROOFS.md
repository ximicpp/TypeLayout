...
is defined as:
    ...
    σ(long double) = LONG_DOUBLE_TAG ++ "[s:" ++ str(sizeof_P(long double)) ++ ",a:" ++ str(alignof_P(long double)) ++ "]"
    -- where LONG_DOUBLE_TAG is determined by __LDBL_MANT_DIG__:
    --   53 -> "fld64", 64 -> "fld80", 106 -> "fld106", 113 -> "fld128"
...
| `long double` | `fld{64,80,106,128}[s:N,a:N]` | Tag encodes representation via `__LDBL_MANT_DIG__` |
